...
def generate_sources(packages):
    ...
    for pkg in pkgs:
        sources_spec[pkg['Package']] = {
            "url": "https://labs.picotech.com/picoscope7/debian/" + pkg["Filename"],
            "sha256": pkg["SHA256"],
            "version": pkg["Version"]
        }
    return sources_spec
...
for nix_system, release in {"x86_64-linux": "amd64"}.items():
    resp = requests.get("https://labs.picotech.com/picoscope7/debian//dists/picoscope/main/binary-"+release+"/Packages")
